...
conversion goal pulling against the experience. Contact exists as a quiet
...
1. **The site IS the portfolio piece.** Its motion, feel, and engineering
   are the evidence. Visitors are judging the thing they're looking at.
2. **Show through craft, not adjectives.** Quality is demonstrated by how
   the interface behaves, not described in copy.
3. **Alive, not loud.** Technically extraordinary motion (GSAP, 3D tilt,
   scroll storytelling) that signals senior taste — never chaotic.
4. **Templates are secondary.** One header link. They never compete with
   the portfolio for attention.

## Ethical stance
Informative, never persuasive. None of the manipulation patterns —
fabricated urgency, confirmshaming, prechecked consent, attention bait —
appear here. There is nothing to convert, so there is nothing to manipulate.
